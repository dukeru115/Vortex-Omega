...
class WebSocketEventHandler:
        ...
        try:
            ...
            if success:
                ...
                await self._send_error(
                    connection_id, "SUBSCRIPTION_FAILED", "Failed to update subscriptions"
                )
    ...
    async def _handle_status_request(self, connection_id: str):
        ...
        try:
            ...
            status_msg = WebSocketMessage(
                event_type=EventType.SYSTEM_STATUS, source="nfcs_orchestrator", data=status_data
            )
    ...
    async def _handle_metrics_request(self, connection_id: str):
        ...
        try:
            ...
            metrics_data = {"websocket_stats": ws_stats, "timestamp": datetime.utcnow().isoformat()}
            ...
            metrics_msg = WebSocketMessage(
                event_type=EventType.TELEMETRY_UPDATE, source="websocket_handler", data=metrics_data
            )
    ...
    async def on_system_state_change(
