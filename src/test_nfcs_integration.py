...
from orchestrator.nfcs_orchestrator import NFCSOrchestrator, create_orchestrator, create_default_config
...
async def test_basic_orchestrator_startup():
    ...
    try:
        ...
        print(f"✅ Final Status: {final_status['statistics']['total_operations']} operations completed")
...
async def test_performance_monitoring():
    ...
    try:
        ...
        if orchestrator.resource_manager:
            ...
            print(f"✅ Resource Status: CPU {resource_status.get('cpu_percent', 0):.1f}%, Memory {resource_status.get('memory_mb', 0):.1f}MB")
...
async def test_emergency_protocols():
    ...
    try:
        ...
        if orchestrator.emergency_controller:
            ...
            print(f"✅ Emergency Controller: {status['registered_conditions']} conditions registered")
