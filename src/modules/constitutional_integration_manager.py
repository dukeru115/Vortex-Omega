...
from modules.early_warning_system import EarlyWarningSystem, EarlyWarningConfiguration, WarningLevel
...
class ConstitutionalIntegrationManager:
    ...
    async def start_monitoring(self):
        ...
        try:
            ...
            print(
                f"📊 WebSocket Dashboard: http://{self.const_config.dashboard_host}:{self.const_config.dashboard_port}"
            )
            print(
                f"📈 Dashboard File: {Path(__file__).parent.parent.parent}/dashboard/constitutional_monitor.html"
            )
    ...
    async def _perform_health_check(self):
        ...
        if (
            self.const_config.enable_websocket_dashboard
            and self.constitutional_monitor
            and not self.constitutional_monitor.websocket_server
        ):
