...
from ..orchestrator.resonance_bus import (
    get_global_bus, publish_risk_metrics, publish_emergency,
    RiskMetricsPayload, TopicType, EventPriority
)
...
class RiskMonitor:
    ...
    def assess_risks(self, risk_metrics: RiskMetrics) -> RiskAssessment:
        ...
        with self._lock:
            try:
                ...
                assessment.defect_risk = self._assess_defect_risk(
                    risk_metrics.rho_def_mean
                )
                ...
                if self.enable_trend_analysis:
                    ...
                    assessment.coherence_global_trend = self.coherence_global_history.get_trend_direction()
                    assessment.coherence_modular_trend = self.coherence_modular_history.get_trend_direction()
                ...
                assessment.systemic_risk_score = self._calculate_systemic_risk(risk_metrics, assessment)
    ...
    def _assess_metric_with_hysteresis(self, 
                                     ...
                                     increasing_is_bad: bool = True) -> RiskLevel:
        """
