...
class MemorySystem:
    ...
    def store_memory(self, 
                    ...
                    constitutional_protected: bool = False) -> str:
    ...
    def retrieve_memory(self, 
        ...
        for memory in all_memories:
            ...
            importance_score = {'critical': 1.0, 'high': 0.8, 'medium': 0.6, 'low': 0.4, 'temporary': 0.2}[memory.importance.value]
    ...
    def get_memory_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'protection_rate': self.stats['constitutional_protections'] / max(1, self.stats['total_memories'])
        }
...
class MemoryModule:
    ...
    def remember(self, content: Dict[str, Any], **kwargs) -> str:
        ...
        constitutional_protected = kwargs.get('constitutional_protected', 
        ...
        return self.memory_system.store_memory(
            ...
            importance=importance,
            constitutional_protected=constitutional_protected,
            **{k: v for k, v in kwargs.items() if k not in ['memory_type', 'importance', 'constitutional_protected']}
        )
    
    def recall(self, query: str, **kwargs) -> List[Dict[str, Any]]:
        """Retrieve memories based on query."""
        memories = self.memory_system.retrieve_memory(query=query, **kwargs)
        return [{'id': m.memory_id, 'content': m.content, 'type': m.memory_type.value} for m in memories]
