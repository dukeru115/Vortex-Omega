...
from .models import SymField, SymClause, KantTestResult, ClauseType, VerificationStatus
...
class KantMode:
    ...
    def _treats_as_means(self, clause: SymClause) -> bool:
        ...
        instrumentalization_found = any(
            pattern in clause_text for pattern in self.instrumentalization_patterns
        )
        ...
        respect_found = any(indicator in clause_text for indicator in respect_indicators)
