...
from .models import (
    SymClause, Expression, Term, Quantity, Unit,
    ClauseType, OperatorType, TermKind
)
...
class SymbolicParser:
    ...
    def _compile_patterns(self) -> Dict[str, re.Pattern]:
        ...
        return {
            ...
            # Greek letters
            'greek': re.compile(r'(α|β|γ|δ|ε|ζ|η|θ|ι|κ|λ|μ|ν|ξ|ο|π|ρ|σ|τ|υ|φ|χ|ψ|ω|Γ|Δ|Θ|Λ|Ξ|Π|Σ|Φ|Ψ|Ω)'),
        }
    ...
    def parse(self, 
             text: str,
             domain_hint: Optional[str] = None) -> List[SymClause]:
        """
    ...
    def _parse_equations(self, statement: str, start_id: int) -> List[SymClause]:
        ...
        for i, match in enumerate(matches):
            ...
            elif op in [OperatorType.LESS, OperatorType.GREATER, 
                       OperatorType.LESS_EQUAL, OperatorType.GREATER_EQUAL]:
    ...
    def _parse_fact(self, 
                   statement: str,
                   clause_id: int,
                   domain_hint: Optional[str]) -> Optional[SymClause]:
