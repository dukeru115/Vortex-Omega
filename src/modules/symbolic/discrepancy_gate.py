...
class DiscrepancyGate:
    ...
    def process(self, report: VerificationReport) -> List[Dict[str, Any]]:
        ...
        sorted_discrepancies = sorted(
            report.discrepancies, key=lambda d: self._severity_score(d), reverse=True
        )
    ...
    def _severity_score(self, discrepancy: Discrepancy) -> float:
        ...
        Returns:
            Severity score (0-1)
        """
        base_score = {"low": 0.3, "medium": 0.6, "high": 0.9}.get(discrepancy.severity, 0.5)
    ...
    def _resolve_numeric_discrepancy(
        self, discrepancy: Discrepancy, report: VerificationReport
    ...
    def _resolve_logic_discrepancy(
        self, discrepancy: Discrepancy, report: VerificationReport
    ) -> Optional[Dict[str, Any]]:
        """
    ...
    def _resolve_temporal_discrepancy(
        self, discrepancy: Discrepancy, report: VerificationReport
    ) -> Optional[Dict[str, Any]]:
        """
    ...
    def _needs_clarification(self, report: VerificationReport, resolutions: List[Dict]) -> bool:
        """
    ...
    def _generate_clarification_questions(
        self, report: VerificationReport, resolutions: List[Dict]
    ) -> List[str]:
        """
    ...
    def apply_resolutions(self, fields: List[SymField], resolutions: List[Dict]) -> List[SymField]:
        """
    ...
    def _apply_resolution_to_clause(self, clause: SymClause, resolution: Dict):
        """
