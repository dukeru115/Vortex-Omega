...
from .models import (
    SymField, SymClause, Discrepancy, Suggestion,
    VerificationStatus, ClauseType, OperatorType
)
...
class SymbolicVerifier:
    ...
    def _check_clause_dimensions(self, clause: SymClause) -> bool:
        ...
        elif clause.op in [OperatorType.LESS, OperatorType.GREATER,
    ...
    def _check_temporal_consistency(self, field: SymField) -> List[Dict[str, Any]]:
        ...
        temporal_clauses = [
            c for c in field.clauses
            if 'temporal' in c.meta or 'time' in str(c.lhs) + str(c.rhs)
        ]
