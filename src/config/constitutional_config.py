...
class ProductionConstitutionalConfig:
    ...
    enable_metrics_persistence: bool = os.getenv('ENABLE_CONSTITUTIONAL_MONITORING', 'true').lower() == 'true'
    database_path: str = os.getenv('CONSTITUTIONAL_DB_PATH', '/app/data/constitutional_monitoring.db')
    ...
    def validate(self) -> bool:
        ...
        if not (0 < self.ha_warning_threshold < self.ha_critical_threshold < self.ha_emergency_threshold):
