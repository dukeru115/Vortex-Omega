...
class TestRegulator:
    ...
    def test_constraint_setting(self, regulator):
        ...
        regulator.set_control_constraints(max_amplitude=2.0, method="SLSQP", max_iter=100, tol=1e-8)
    ...
    def test_feedback_control_basic(self, regulator, test_state):
        ...
        control_signals = regulator.compute_feedback_control(test_state, target_coherence=0.8)
    ...
    def test_feedback_control_coherence_response(self, regulator, test_state):
        ...
        control_low = regulator.compute_feedback_control(test_state, target_coherence=0.8)
        ...
        control_high = regulator.compute_feedback_control(test_state, target_coherence=0.8)
